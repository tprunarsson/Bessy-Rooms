...
# + 50 * sum{c in CidAssign, b in Building: b == 'Eirberg' and b not in PriorityBuildings[c] and b not in CourseInBuilding[c]} wb[c,b]
# + 10000 * sum{c in CidAssign, b in Building: b == 'Eirberg'} wb[c,b]
